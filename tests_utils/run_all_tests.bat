...
REM Ejecutar todas las pruebas de modelos
echo Ejecutando pruebas de modelos...
docker-compose exec web python -m django test apps.reloj_fichador.tests.test_models -v 2 --settings=tests_utils.sqlite_settings
