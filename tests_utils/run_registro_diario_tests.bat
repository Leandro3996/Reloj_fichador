...
REM Ejecutar pruebas de registro diario
echo Ejecutando pruebas de registro diario...
docker-compose exec web python -m django test apps.reloj_fichador.tests.test_registro_diario -v 2 --settings=tests_utils.sqlite_settings
